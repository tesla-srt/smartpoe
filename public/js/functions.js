...
(function connect() {
    ...
    socket.on('receive_update', data => {
        ...
        $("#loadMe").modal('hide');
        let stream1 = portInfo.ports[0].stream ? null;
        let stream2 = portInfo.ports[1].stream ? null;
        let stream3 = portInfo.ports[2].stream ? null;
        let stream4 = portInfo.ports[3].stream ? null;
        portInfo = data;
    ...
    $('#cam1').on("click", async function (event) {
    ...
    $('#cam2').on("click", async function (event) {
        event.stopPropagation();
        if ($(this).hasClass('disabled') == false) {
            //clearInterval(i1)
    ...
    $('#cam3').on("click", async function (event) {
        event.stopPropagation();
        if ($(this).hasClass('disabled') == false) {
            //clearInterval(i1)
    ...
    $('#cam4').on("click", async function (event) {
        event.stopPropagation();
        if ($(this).hasClass('disabled') == false) {
            //clearInterval(i1)
    ...
    $('#cam2live').on('show.bs.modal', function () {
        $('#loadMe').modal('hide');
    })
    ...
    $('#cam3live').on('show.bs.modal', function () {
        $('#loadMe').modal('hide');
    })
